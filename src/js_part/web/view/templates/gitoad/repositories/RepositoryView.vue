<template>
    ...
    <main class="repository" v-if="repository">

      <RepositoryFullName :repository="repository" :store="store"/>
               ...
               <section class="info" v-show="repository.files.length > 0">
                ...
                <section class="main-grid" v-show="repository.files.length > 0">
                    <div class="main-grid__line-com">
                        <p class="main-grid__text-com" @click="commitsMode">
        ...
        <div class="content-rep">
          ...
          />
          <div class="frog" v-if="!repository.files && !loadingRepo">
...
export default {
    name: "RepositoryView",
    components: {RepositoryFullName, LangsInfo, RepositoryInfo, FileEditor, BulletListLoader, ListLoader, FileManager},
    data() {
        return {
            repository: {},
            loadingFile: false,
    ...
    methods: {
        ...
        loadFile(file) {
            ...
            return this.$gitoadFileMutations.gitoadSetPath(file)
                ...
                .then(t => {
                    file = t['file']
                    this.$gitoadFileMutations.gitoadSetFile(file)
                })
                .then(() => {
                    this.loadingFile = false
                })
      ...
      getRepo(sha) {
        ...
        this.$gitoad.repos.getRepo(body)
            ...
            .then(t => {
              ...
              this.$gitoadRepositoryMutations.gitoadSetBranch(this.repository.currentBranch)
              this.$gitoadRepositoryMutations.gitoadSetRepositoryName(this.repository.name)
              this.$gitoadRepositoryMutations.gitoadSetRepository(this.repository)
              this.$gitoadRepositoryMutations.gitoadSetCommits(this.repository.commits)
        ...
        commitsMode() {
          this.$gitoadModesMutations.gitoadSetCommitsMode()
        ...
        changeCurrentBranch(branch) {
            this.$gitoadFileMutations.gitoadClearFile()
            this.$gitoadFileMutations.gitoadSetBranch(branch)
