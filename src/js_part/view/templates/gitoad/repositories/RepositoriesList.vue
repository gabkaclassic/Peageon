...
import GitoadRepositoriesSearchBar from "@/js_part/view/templates/searchBars/GitoadRepositoriesSearchBar.vue";
import RepositoryView from "@/js_part/view/templates/gitoad/repositories/RepositoryView.vue";
